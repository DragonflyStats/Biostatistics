...
The critical value is an F value at \alpha % significance, with degrees of freedom 2 and n-2, where n is the number of paired values.
...
\subsection8{analytical chemistry}
