...
\chapter{Application to Method Comparison Studies} % Chapter 3
...
%-------------------------------------------------------------------------------------------------------%
\chapter{Appendices} % Chapter 4 (was 3)
%---------------------------------------------------------------------------------------------------------%
% Appendices
% - Sherman Morrison Woodbury Formula (3.1)
% - The Hat Matrix (and Hat Matrix applied to MCS) (3.2)
% - Cross Validation (Updating standard deviation) (3.3)
% - Updating Estimates (3.4)
% - Lesaffre's paper (3.5)
%---------------------------------------------------------------------------------------------------------%
\section{Sherman Morrison Woodbury Formula} % 3.1
...
%------------------------------------------------------------------------%
\newpage
\section{Updating Estimates} %3.4
